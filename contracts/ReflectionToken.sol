...
import "./BotProtection.sol";

contract ReflectionToken is Context, IERC20, Ownable, Initializable, BotProtection {
    ...
    address[] public _excludedFromFee;
    ...
    function transfer(address recipient, uint256 amount) public override blocksTransfers(_msgSender(), recipient) returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override blocksTransfers(sender, recipient) returns (bool) {
